 ...
 *
 * « En cours d'importation » garde le bleu ciel d'« en route », dont il est la
 * fin (le fichier est complet, pas encore rangé) : ni teinte à lui — toute
 * teinte libre frôle un état voisin, la leçon d'« en partie » — ni animation.
 * Son icône (un bac où entre une flèche) et son mot le distinguent.
 *
...
--vg-importing-fg:#7DD3FC;--vg-importing-bg:rgba(14,165,233,0.18);--vg-importing-solid:#0EA5E9;
...
--vg-importing-fg:#0369A1;--vg-importing-bg:rgba(2,132,199,0.11);--vg-importing-solid:#0284C7;
...
--vg-media-requested:#C4B5FD;--vg-media-downloading:#7DD3FC;--vg-media-importing:#7DD3FC;--vg-media-stalled:#FCD34D;
