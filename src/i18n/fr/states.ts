...
export default {
  ...
  // Ce qui manque à une série en partie là (cf. utils/series-gaps.ts).
  gapShortSeasons_one: "Il manque {{count}} saison",
  gapShortSeasons_other: "Il manque {{count}} saisons",
  gapShortEpisodes: "Il manque des épisodes",
  gapShortBoth_one: "Il manque {{count}} saison et des épisodes",
  gapShortBoth_other: "Il manque {{count}} saisons et des épisodes",
  gapSeasonList_one: "la saison {{list}}",
  gapSeasonList_other: "les saisons {{list}}",
  gapSeasonMany: "{{count}} saisons",
  gapOfSeasonList_one: "de la saison {{list}}",
  gapOfSeasonList_other: "des saisons {{list}}",
  gapOfSeasonMany: "de {{count}} saisons",
  gapLongSeasons: "Il manque {{what}}",
  gapLongEpisodes: "Il manque des épisodes {{of}}",
  gapLongBoth: "Il manque {{what}}, et des épisodes {{of}}",
  gapAnd: " et ",
} as const;
