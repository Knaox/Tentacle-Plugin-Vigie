...
export default {
  ...
  profileDefaultChoice: "Default quality",
  filterAllTypes: "All",
  type_all: "All",
  titleAll_all: "The whole catalog",
  ...
  gapShortSeasons_one: "{{count}} season missing",
  gapShortSeasons_other: "{{count}} seasons missing",
  gapShortEpisodes: "Some episodes missing",
  gapShortBoth_one: "{{count}} season and some episodes missing",
  gapShortBoth_other: "{{count}} seasons and some episodes missing",
  gapSeasonList_one: "season {{list}}",
  gapSeasonList_other: "seasons {{list}}",
  gapSeasonMany: "{{count}} seasons",
  gapOfSeasonList_one: "of season {{list}}",
  gapOfSeasonList_other: "of seasons {{list}}",
  gapOfSeasonMany: "of {{count}} seasons",
  gapLongSeasons: "Missing {{what}}",
  gapLongEpisodes: "Missing episodes {{of}}",
  gapLongBoth: "Missing {{what}}, and episodes {{of}}",
  gapAnd: " and ",
} as const;
